...
Trigger(name='camera_trigger_0',           parent_device=pulseblaster_0.direct_outputs, connection='flag 13',
        trigger_edge_type='falling')
DigitalOut(name='DDS_A_update',            parent_device=pulseblaster_0.direct_outputs, connection='flag 14')        
DigitalOut(name='DDS_B_update',            parent_device=pulseblaster_0.direct_outputs, connection='flag 15')
...
AnalogOut(name='Bragg_repump',                 parent_device=ni_pci_6733_0, connection='ao1')
...
DigitalOut(name='Bragg_probeTTL',                parent_device=ni_pci_6733_0, connection='port0/line6')
...
NI_DAQmx(name='ni_pci_6733_1', parent_device=pulseblaster_0_ni_pci_clock,
        MAX_name='Dev2',
...
AnalogOut(name='RF_mixer2',               parent_device=ni_pci_6733_1, connection='ao2')              
...
DigitalOut(name='RF_DDS_sel_0',           parent_device=ni_pci_6733_1, connection='port0/line0')
DigitalOut(name='RF_DDS_sel_1',           parent_device=ni_pci_6733_1, connection='port0/line1')
DigitalOut(name='RF_DDS_switch_0',        parent_device=ni_pci_6733_1, connection='port0/line2')
...
DigitalOut(name='uWave_DDS_sel_1',        parent_device=ni_pci_6733_1, connection='port0/line5')
DigitalOut(name='uWave_DDS_switch_0',     parent_device=ni_pci_6733_1, connection='port0/line6')
...
NI_DAQmx(name='ni_usb_6343_1', parent_device=pulseblaster_0_ni_usb_1_clock,
        MAX_name='Dev4',
...
DigitalOut(name='DO_7',             parent_device=ni_usb_6343_2, connection = 'port0/line7')
...
#AnalogOut(name='AO0',     parent_device=ni_usb_6002_0, connection='ao0')
#AnalogOut(name='AO1',     parent_device=ni_usb_6002_0, connection='ao1')

#DigitalOut(name='DO6_0',  parent_device=ni_usb_6002_0, connection='port0/line0')
#DigitalOut(name='DO6_1',  parent_device=ni_usb_6002_0, connection='port0/line1')
#DigitalOut(name='DO6_2',  parent_device=ni_usb_6002_0, connection='port0/line2')
#DigitalOut(name='DO6_3',  parent_device=ni_usb_6002_0, connection='port0/line3')
#DigitalOut(name='DO6_4',  parent_device=ni_usb_6002_0, connection='port0/line4')
#DigitalOut(name='DO6_5',  parent_device=ni_usb_6002_0, connection='port0/line5')
#DigitalOut(name='DO6_6',  parent_device=ni_usb_6002_0, connection='port0/line6')
#DigitalOut(name='DO6_7',  parent_device=ni_usb_6002_0, connection='port0/line7')
...
NovaTechDDS9M(name='novatechdds9m_2', parent_device=pulseblaster_0_novatech_0_clock, com_port='com9',
              baud_rate = 19200, default_baud_rate=19200, update_mode='asynchronous')

DDS(name='MOT_lock',            parent_device=novatechdds9m_2, connection='channel 0')
DDS(name='RF_evap',         parent_device=novatechdds9m_2, connection='channel 1')
StaticDDS(name='AOM_Raman_2',   parent_device=novatechdds9m_2, connection='channel 2')
StaticDDS(name='Nov_0_3',       parent_device=novatechdds9m_2, connection='channel 3')

NovaTechDDS9M(name='novatechdds9m_1', parent_device=pulseblaster_0_novatech_1_clock, com_port='com7',
              baud_rate = 19200, default_baud_rate=19200, update_mode='asynchronous')

DDS(name='AOM_Raman_1',         parent_device=novatechdds9m_1, connection='channel 0')
...
#["AcquisitionAttributes::VideoMode", "Format 7, Mode 1, 324 x 244"], # 13
...
Camera(name='XY_1_Flea3', parent_device=camera_trigger_1, connection='trigger', trigger_edge_type='falling',
         BIAS_port=1027, SDK='IMAQdx_Flea3_Firewire', effective_pixel_size=5.9e-6, orientation = 'xy', 
         exposure_time=100e-6,
         serial_number=0x00B09D0100AC001B, 
         added_properties=IMAQdx_properties
          )
          
#Camera(name='XY_2_Flea3', parent_device=camera_trigger_0, connection='trigger', trigger_edge_type='falling',
#         BIAS_port=1028, SDK='IMAQdx_Flea3_Firewire', effective_pixel_size=5.9e-6, orientation = 'xy', 
#         exposure_time=100e-6,
#         serial_number=0x00B09D0100AB1223, 
#         added_properties=IMAQdx_properties
#          )  

Camera(name='YZ_1_Flea3', parent_device=camera_trigger_0, connection='trigger', trigger_edge_type='falling',
         BIAS_port=1029, SDK='IMAQdx_Flea3_Firewire', effective_pixel_size=5.9e-6, orientation = 'yz', 
         exposure_time=100e-6,
         serial_number=0x00B09D0100ABFFE9, 
         added_properties=IMAQdx_properties
          )      
